...
private:
  ...
  std::unique_ptr<ThreadSafeOrderedList<TimePointTask>> task_list_; // List of Jobs in a ThreadSafeOrderedList
  ...
  std::atomic_bool stop_flag_{false}; // Used to stop the threads
};
} // namespace job_manager
} // namespace vm
